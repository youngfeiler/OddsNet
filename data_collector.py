...
class data_collector():
    def __init__(self, from_stacked=True,  min_minutes_since_commence=-1000000, max_minutes_since_commence=2400, min_avg_odds=0, max_avg_odds = 10000, min_ev=10, max_ev=1000, min_best_odds = -1, max_best_odds = 1000, n_last_games_odds = 3, n_last_games_win_perc = 10, n_last_matchups_odds = 3, n_last_matchups_record = 5):
        ...
        if from_stacked:
            ...
            self.df.to_parquet('/Users/stefanfeiler/Desktop/SmartBetter/SmartBetter/data/stacked_w_opponent.parquet')
